...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background_container prlx_parent">
			<div class="home_background prlx" style="background-image:url(images/internship.jpeg)"></div>
		</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h1>CDCRC Innovation Internship</h1>
					</div>
				</div>
			</div>
			<div class="row">
				&nbsp;<h2 style="color: #000000;">A CDCRC Innovation Internship programme was initiated in June 2018 which has five IIT Ropar students in the current cohort. The idea is to engage student   talent to achieve institutional objectives like excellent industry relations, prolonged industry engagement through placement and internships and professional development. The following students were selected for the June 2018 intake:</h2>
				<ol type="1" style="padding-left: 2em; color: #000000;">
					<h2><li>Ahsaas Sharma  - Mechanical Engineering</li></h2>
					<h2><li>Bhawna Paliwal - Chemical Engineering</li></h2>
					<h2><li>Chirag Khurana - Computer Science and Engineering</li></h2>
					<h2><li>Munish - Civil Engineering</li></h2>
					<h2><li>Radhika Wadhawan - Mechanical Engineering</li></h2>
				</ol>
